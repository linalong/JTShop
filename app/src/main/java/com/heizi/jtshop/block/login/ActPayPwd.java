 ...
 */
public class ActPayPwd extends BaseSwipeBackCompatActivity implements
    ...
    protected void initData() {
        super.initData();
        rp = new ParseObjectProtocol(this, SERVER_URL_SHOP + "&method=jingtu.user_center.editPayPassword.post/", UserModel.class);
        rpcb = new IResponseCallback<DataSourceModel<UserModel>>() {
            ...
            public void onSuccess(DataSourceModel<UserModel> t) {
                ...
                LoadingD.hideDialog();
                Utils.toastShow(ActPayPwd.this, "支付密码设置成功!");
//                try {
//                    userModel = t.temp;
//                    if (!TextUtils.isEmpty(userModel.getMember_id())) {
                userModel.setMember_paypwd(MD5.md5(et_paypwd.getText().toString()));
...
//                }
            ...
            public void onStart() {
                // TODO Auto-generated method stub
                LoadingD.showDialog(ActPayPwd.this);
            }
            ...
            public void onFailure(ErrorModel errorModel) {
                // TODO Auto-generated method stub
                LoadingD.hideDialog();
                Utils.toastShow(ActPayPwd.this, errorModel.getMsg());
            }
        };
        ...
        gcpcb = new IResponseCallback<DataSourceModel<String>>() {
            ...
            public void onSuccess(DataSourceModel<String> t) {
                // TODO Auto-generated method stub
                LoadingD.hideDialog();
                Utils.toastShow(ActPayPwd.this, "发送成功");
                if (mc != null)
                    mc.cancel();
...
//		}
    ...
    private boolean checkData() {
        if (Utils.isNull(et_paypwd.getText().toString())) {
            ...
            Utils.toastShow(this, "支付密码长度为6~20位");
            return false;
        } else if (Utils.isNull(et_repaypwd.getText().toString())) {
            Utils.toastShow(this, "请再次输入支付密码");
            return false;
    ...
    public class SaveThread extends Thread {
        ...
        public void run() {
            ...
            RefreshUtils.sendBroadcast(ActPayPwd.this, userModel);
